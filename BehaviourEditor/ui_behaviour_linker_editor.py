...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 30, 161, 151))
        ...
        self.scrollAreaWidgetContentsLeft.setGeometry(QtCore.QRect(0, 0, 302, 547))
        ...
        self.scrollAreaWidgetContentsInterNetworks.setGeometry(QtCore.QRect(0, 0, 180, 263))
        ...
        self.scrollAreaWidgetContentsEntities.setGeometry(QtCore.QRect(0, 0, 180, 262))
        ...
        self.scrollAreaWidgetContentsVariants.setGeometry(QtCore.QRect(0, 0, 180, 263))
        ...
        self.pushButtonNodeAssociations = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.pushButtonNodeAssociations.setObjectName("pushButtonNodeAssociations")
        self.verticalLayout_2.addWidget(self.pushButtonNodeAssociations)
        self.pushButtonArcAssociations = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.pushButtonArcAssociations.setObjectName("pushButtonArcAssociations")
        self.verticalLayout_2.addWidget(self.pushButtonArcAssociations)
        ...
        self.scrollAreaWidgetContentsRight.setGeometry(QtCore.QRect(0, 0, 303, 547))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonNodeAssociations.setText(_translate("MainWindow", "node associations"))
        self.pushButtonArcAssociations.setText(_translate("MainWindow", "arc associations"))
