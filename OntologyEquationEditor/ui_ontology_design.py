...
class Ui_OntologyDesigner(object):
    def setupUi(self, OntologyDesigner):
        ...
        self.widget = QtWidgets.QWidget(self.groupOntology)
        self.widget.setGeometry(QtCore.QRect(20, 30, 341, 131))
        ...
        self.pushCompile = QtWidgets.QPushButton(self.widget)
        ...
        self.groupFiles.setGeometry(QtCore.QRect(20, 190, 301, 61))
